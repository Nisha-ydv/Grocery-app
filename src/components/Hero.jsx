...
function Hero() {
  return (
    <div className='relative'>
      ...
      <div className='absolute inset-0 flex-col items-center md:items-start justify-end md:justify-center pb-24 md:pb-0 md:pl-18 lg:pl-24'>
       <h1 className='text-3xl md:text-4xlfont-bold text-center md:text-left max-w-72 md:max-80 leading-tight lg:leading-15 mt-18'>
